...
describe("DeleteSpaceUseCase", () => {
    ...
    it("should delete an existing space", async () => {
        ...
        expect(spacesRepository.delete).toHaveBeenCalledWith("space-1");
    });
    ...
    it("should return SpaceNotFoundError when space does not exist", async () => {
        ...
        expect(spacesRepository.delete).not.toHaveBeenCalled();
    });
});
